package com.cn.my.codegenerator.utils;

import com.cn.my.codegenerator.bean.BDException;
import com.cn.my.codegenerator.bean.ColumnDO;
import com.cn.my.codegenerator.bean.TableDO;
import com.cn.my.codegenerator.config.Constant;
...
public class GenUtils {
    ...
    public static List<String> getTemplates() {
        ...
        templates.add("templates/common/generator/FeignApi.java.vm");
        templates.add("templates/common/generator/FeignClient.java.vm");
        templates.add("templates/common/generator/FeignHystrix.java.vm");
...
//		}
        if (template.contains("FeignApi.java.vm")) {
            return packagePath + "feignApi" + File.separator + className + "FeignApi.java";
        }
        if (template.contains("FeignClient.java.vm")) {
            return packagePath + "feignApi" + File.separator + className + "FeignClient.java";
        }
        if (template.contains("FeignHystrix.java.vm")) {
            return packagePath + "feignApi" + File.separator + className + "FeignHystrix.java";
        }
        return null;
    }
}
